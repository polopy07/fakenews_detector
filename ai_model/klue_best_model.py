...
random.shuffle(data)
texts = [item['text'] for item in data if item['text']]6
...
# ✅ 모델 저장
model.save_pretrained("./best_model_optuna")
tokenizer.save_pretrained("./best_model_optuna")
